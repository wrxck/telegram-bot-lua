...
function api.send_message(message, text, message_thread_id, parse_mode, entities, link_preview_options, disable_notification, protect_content, reply_parameters, reply_markup) -- https://core.telegram.org/bots/api#sendmessage
...
function api.send_reply(message, text, message_thread_id, parse_mode, entities, link_preview_options, disable_notification, protect_content, reply_parameters, reply_markup) -- A variant of api.send_message(), optimised for sending a message as a reply.
...
function api.forward_messages(chat_id, from_chat_id, message_ids, message_thread_id, disable_notification, protect_content) -- https://core.telegram.org/bots/api#forwardmessages
  ...
  local success, res = api.request(
    config.endpoint .. api.token .. '/forwardMessages',
    {
        ['chat_id'] = chat_id,
        ['message_thread_id'] = message_thread_id,
        ['from_chat_id'] = from_chat_id,
...
function api.copy_message(chat_id, from_chat_id, message_id, message_thread_id, caption, parse_mode, caption_entities, disable_notification, protect_content, reply_parameters, reply_markup) -- https://core.telegram.org/bots/api#copymessage
  caption_entities = type(caption_entities) == 'table' and json.encode(caption_entities) or caption_entities
  reply_parameters = type(reply_parameters) == 'table' and json.encode(reply_parameters) or reply_parameters
  reply_markup = type(reply_markup) == 'table' and json.encode(reply_markup) or reply_markup
  local success, res = api.request(
    config.endpoint .. api.token .. '/copyMessage',
    {
        ['chat_id'] = chat_id,
        ['message_thread_id'] = message_thread_id,
        ['from_chat_id'] = from_chat_id,
...
function api.copy_messages(chat_id, from_chat_id, message_ids, message_thread_id, disable_notification, protect_content, remove_caption) -- https://core.telegram.org/bots/api#copymessages
  message_ids = type(message_ids) == 'table' and json.encode(message_ids) or message_ids
  local success, res = api.request(
    config.endpoint .. api.token .. '/copyMessages',
    {
        ['chat_id'] = chat_id,
        ['message_thread_id'] = message_thread_id,
        ['from_chat_id'] = from_chat_id,
...
function api.send_photo(chat_id, photo, message_thread_id, caption, parse_mode, caption_entities, has_spoiler, disable_notification, protect_content, reply_parameters, reply_markup) -- https://core.telegram.org/bots/api#sendphoto
    caption_entities = type(caption_entities) == 'table' and json.encode(caption_entities) or caption_entities
    reply_parameters = type(reply_parameters) == 'table' and json.encode(reply_parameters) or reply_parameters
    reply_markup = type(reply_markup) == 'table' and json.encode(reply_markup) or reply_markup
    local success, res = api.request(
...
function api.send_audio(chat_id, audio, message_thread_id, caption, parse_mode, caption_entities, duration, performer, title, thumbnail, disable_notification, protect_content, reply_parameters, reply_markup) -- https://core.telegram.org/bots/api#sendaudio
    caption_entities = type(caption_entities) == 'table' and json.encode(caption_entities) or caption_entities
    reply_parameters = type(reply_parameters) == 'table' and json.encode(reply_parameters) or reply_parameters
    reply_markup = type(reply_markup) == 'table' and json.encode(reply_markup) or reply_markup
    local success, res = api.request(
...
function api.send_document(chat_id, document, message_thread_id, thumbnail, caption, parse_mode, caption_entities, disable_content_type_detection, disable_notification, protect_content, reply_parameters, reply_markup) -- https://core.telegram.org/bots/api#senddocument
    caption_entities = type(caption_entities) == 'table' and json.encode(caption_entities) or caption_entities
    reply_parameters = type(reply_parameters) == 'table' and json.encode(reply_parameters) or reply_parameters
    reply_markup = type(reply_markup) == 'table' and json.encode(reply_markup) or reply_markup
    local success, res = api.request(
...
function api.send_video(chat_id, video, message_thread_id, duration, width, height, caption, parse_mode, has_spoiler, supports_streaming, disable_notification, protect_content, reply_parameters, reply_markup) -- https://core.telegram.org/bots/api#sendvideo
    caption_entities = type(caption_entities) == 'table' and json.encode(caption_entities) or caption_entities
    reply_parameters = type(reply_parameters) == 'table' and json.encode(reply_parameters) or reply_parameters
    reply_markup = type(reply_markup) == 'table' and json.encode(reply_markup) or reply_markup
    local success, res = api.request(
...
function api.send_animation(chat_id, animation, message_thread_id, duration, width, height, thumbnail, caption, parse_mode, caption_entities, has_spoiler, disable_notification, protect_content, reply_parameters, reply_markup) -- https://core.telegram.org/bots/api#sendanimation
    caption_entities = type(caption_entities) == 'table' and json.encode(caption_entities) or caption_entities
    reply_parameters = type(reply_parameters) == 'table' and json.encode(reply_parameters) or reply_parameters
    reply_markup = type(reply_markup) == 'table' and json.encode(reply_markup) or reply_markup
    local success, res = api.request(
...
function api.send_voice(chat_id, voice, message_thread_id, caption, parse_mode, caption_entities, duration, disable_notification, protect_content, reply_parameters, reply_markup) -- https://core.telegram.org/bots/api#sendvoice
    caption_entities = type(caption_entities) == 'table' and json.encode(caption_entities) or caption_entities
    reply_parameters = type(reply_parameters) == 'table' and json.encode(reply_parameters) or reply_parameters
    reply_markup = type(reply_markup) == 'table' and json.encode(reply_markup) or reply_markup
    local success, res = api.request(
...
function api.send_video_note(chat_id, video_note, message_thread_id, duration, length, thumbnail, disable_notification, protect_content, reply_parameters, reply_markup) -- https://core.telegram.org/bots/api#sendvideonote
    reply_parameters = type(reply_parameters) == 'table' and json.encode(reply_parameters) or reply_parameters
    reply_markup = type(reply_markup) == 'table' and json.encode(reply_markup) or reply_markup
    local success, res = api.request(
...
function api.send_location(chat_id, latitude, longitude, message_thread_id, horizontal_accuracy, live_period, heading, proximity_alert_radius, disable_notification, protect_content, reply_parameters, reply_markup) -- https://core.telegram.org/bots/api#sendlocation
    reply_parameters = type(reply_parameters) == 'table' and json.encode(reply_parameters) or reply_parameters
    reply_markup = type(reply_markup) == 'table' and json.encode(reply_markup) or reply_markup
    local success, res = api.request(
...
function api.edit_message_live_location(chat_id, message_id, inline_message_id, latitude, longitude, horizontal_accuracy, heading, proximity_alert_radius, reply_markup) -- https://core.telegram.org/bots/api#editmessagelivelocation
    reply_markup = type(reply_markup) == 'table' and json.encode(reply_markup) or reply_markup
    local success, res = api.request(
...
function api.send_venue(chat_id, latitude, longitude, title, address, message_thread_id, foursquare_id, foursquare_type, google_place_id, google_place_type, disable_notification, protect_content, reply_parameters, reply_markup) -- https://core.telegram.org/bots/api#sendvenue
    reply_parameters = type(reply_parameters) == 'table' and json.encode(reply_parameters) or reply_parameters
    reply_markup = type(reply_markup) == 'table' and json.encode(reply_markup) or reply_markup
    local success, res = api.request(
...
function api.send_contact(chat_id, phone_number, first_name, last_name, message_thread_id, vcard, disable_notification, protect_content, reply_parameters, reply_markup) -- https://core.telegram.org/bots/api#sendcontact
    reply_parameters = type(reply_parameters) == 'table' and json.encode(reply_parameters) or reply_parameters
    reply_markup = type(reply_markup) == 'table' and json.encode(reply_markup) or reply_markup
    local success, res = api.request(
...
function api.send_poll(chat_id, question, options, message_thread_id, is_anonymous, poll_type, allows_multiple_answers, correct_option_id, explanation, explanation_parse_mode, explanation_entities, open_period, close_date, is_closed, disable_notification, protect_content, reply_parameters, reply_markup) -- https://core.telegram.org/bots/api#sendpoll
...
function api.set_message_reaction(chat_id, message_id, reaction, is_big) -- https://core.telegram.org/bots/api#setmessagereaction
    ...
    local success, res = api.request(
        config.endpoint .. api.token .. '/setMessageReaction',
        {
            ['chat_id'] = chat_id,
            ['message_id'] = message_id,
            ['reaction'] = reaction,
...
function api.promote_chat_member(chat_id, user_id, is_anonymous, can_manage_chat, can_delete_messages, can_manage_video_chats, can_restrict_members, can_promote_members, can_change_info, can_invite_users, can_post_messages, can_edit_messages, can_pin_messages, can_post_stories, can_edit_stories, can_delete_stories, can_manage_topics) -- https://core.telegram.org/bots/api#promotechatmember
    local success, res = api.request(
...
function api.ban_chat_sender_chat(chat_id, sender_chat_id) -- https://core.telegram.org/bots/api#banchatsenderchat
  local success, res = api.request(
      config.endpoint .. api.token .. '/banChatSenderChat',
      {
          ['chat_id'] = chat_id,
...
function api.unban_chat_sender_chat(chat_id, sender_chat_id) -- https://core.telegram.org/bots/api#unbanchatsenderchat
  local success, res = api.request(
      config.endpoint .. api.token .. '/unbanChatSenderChat',
      {
          ['chat_id'] = chat_id,
          ['sender_chat_id'] = sender_chat_id
      }
...
function api.create_chat_invite_link(chat_id, name, expire_date, member_limit, creates_join_request) -- https://core.telegram.org/bots/api#createchatinvitelink
    ...
    local success, res = api.request(
        config.endpoint .. api.token .. '/createChatInviteLink',
        {
            ['chat_id'] = chat_id,
            ['name'] = name,
...
function api.edit_chat_invite_link(chat_id, invite_link, name, expire_date, member_limit, creates_join_request) -- https://core.telegram.org/bots/api#editchatinvitelink
    ...
    local success, res = api.request(
        config.endpoint .. api.token .. '/editChatInviteLink',
        {
            ['chat_id'] = chat_id,
...
function api.revoke_chat_invite_link(chat_id, invite_link) -- https://core.telegram.org/bots/api#revokechatinvitelink
    local success, res = api.request(
        config.endpoint .. api.token .. '/revokeChatInviteLink',
        {
            ['chat_id'] = chat_id,
            ['invite_link'] = invite_link
        }
...
function api.approve_chat_join_request(chat_id, user_id) -- https://core.telegram.org/bots/api#approvechatjoinrequest
    local success, res = api.request(
        config.endpoint .. api.token .. '/approveChatJoinRequest',
        {
            ['chat_id'] = chat_id,
            ['user_id'] = user_id
        }
...
function api.decline_chat_join_request(chat_id, user_id) -- https://core.telegram.org/bots/api#declinechatjoinrequest
    local success, res = api.request(
        config.endpoint .. api.token .. '/declineChatJoinRequest',
        {
            ['chat_id'] = chat_id,
            ['user_id'] = user_id
        }
...
function api.unpin_all_chat_messages(chat_id) -- https://core.telegram.org/bots/api#unpinallchatmessages
    local success, res = api.request(
        config.endpoint .. api.token .. '/unpinAllChatMessages',
        { ['chat_id'] = chat_id }
    )
    return success, res
end
...
function api.create_forum_topic(chat_id, name, icon_color, icon_custom_emoji_id) -- https://core.telegram.org/bots/api#createforumtopic
    ...
    local success, res = api.request(
        config.endpoint .. api.token .. '/createForumTopic',
        {
            ['chat_id'] = chat_id,
            ['name'] = name,
...
function api.edit_forum_topic(chat_id, message_thread_id, name, icon_custom_emoji_id) -- https://core.telegram.org/bots/api#editforumtopic
    ...
    local success, res = api.request(
        config.endpoint .. api.token .. '/editForumTopic',
        {
            ['chat_id'] = chat_id,
            ['message_thread_id'] = message_thread_id,
            ['name'] = name,
...
function api.close_forum_topic(chat_id, message_thread_id) -- https://core.telegram.org/bots/api#closeforumtopic
    local success, res = api.request(
        config.endpoint .. api.token .. '/closeForumTopic',
        {
            ['chat_id'] = chat_id,
            ['message_thread_id'] = message_thread_id
        }
...
function api.reopen_forum_topic(chat_id, message_thread_id) -- https://core.telegram.org/bots/api#reopenforumtopic
    local success, res = api.request(
        config.endpoint .. api.token .. '/reopenForumTopic',
        {
            ['chat_id'] = chat_id,
            ['message_thread_id'] = message_thread_id
        }
...
function api.delete_forum_topic(chat_id, message_thread_id) -- https://core.telegram.org/bots/api#deleteforumtopic
    local success, res = api.request(
        config.endpoint .. api.token .. '/deleteForumTopic',
        {
            ['chat_id'] = chat_id,
            ['message_thread_id'] = message_thread_id
        }
...
function api.unpin_all_forum_topic_messages(chat_id, message_thread_id) -- https://core.telegram.org/bots/api#unpinallforumtopicmessages
    local success, res = api.request(
        config.endpoint .. api.token .. '/unpinAllForumTopicMessages',
        {
            ['chat_id'] = chat_id,
            ['message_thread_id'] = message_thread_id
        }
...
function api.edit_general_forum_topic(chat_id, name) -- https://core.telegram.org/bots/api#editgeneralforumtopic
    ...
    local success, res = api.request(
        config.endpoint .. api.token .. '/editGeneralForumTopic',
        {
            ['chat_id'] = chat_id,
            ['name'] = tostring(name)
        }
...
function api.close_general_forum_topic(chat_id) -- https://core.telegram.org/bots/api#closegeneralforumtopic
    local success, res = api.request(
        config.endpoint .. api.token .. '/closeGeneralForumTopic',
        { ['chat_id'] = chat_id }
    )
    return success, res
end
...
function api.reopen_general_forum_topic(chat_id) -- https://core.telegram.org/bots/api#reopengeneralforumtopic
    local success, res = api.request(
        config.endpoint .. api.token .. '/reopenGeneralForumTopic',
        { ['chat_id'] = chat_id }
    )
    return success, res
end
...
function api.hide_general_forum_topic(chat_id) -- https://core.telegram.org/bots/api#hidegeneralforumtopic
    local success, res = api.request(
        config.endpoint .. api.token .. '/hideGeneralForumTopic',
        { ['chat_id'] = chat_id }
    )
    return success, res
end
...
function api.unhide_general_forum_topic(chat_id) -- https://core.telegram.org/bots/api#unhidegeneralforumtopic
    local success, res = api.request(
        config.endpoint .. api.token .. '/unhideGeneralForumTopic',
        { ['chat_id'] = chat_id }
    )
    return success, res
end
...
function api.unpin_all_general_forum_topic_messages(chat_id) -- https://core.telegram.org/bots/api#unpinallgeneralforumtopicmessages
    local success, res = api.request(
        config.endpoint .. api.token .. '/unpinAllGeneralForumTopicMessages',
        { ['chat_id'] = chat_id }
    )
    return success, res
end
...
function api.get_user_chat_boosts(chat_id, user_id) -- https://core.telegram.org/bots/api#getUserChatBoosts
    local success, res = api.request(
        config.endpoint .. api.token .. '/getUserChatBoosts',
        {
            ['chat_id'] = chat_id,
            ['user_id'] = user_id
        }
...
function api.delete_my_commands(scope, language_code) -- https://core.telegram.org/bots/api#deletemycommands
    scope = type(scope) == 'table' and json.encode(scope) or scope
    local success, res = api.request(
        config.endpoint .. api.token .. '/deleteMyCommands',
        {
            ['scope'] = scope,
            ['language_code'] = language_code
        }
...
function api.get_my_commands(scope, language_code) -- https://core.telegram.org/bots/api#getmycommands
    scope = type(scope) == 'table' and json.encode(scope) or scope
    local success, res = api.request(
        config.endpoint .. api.token .. '/getMyCommands',
        {
            ['scope'] = scope,
            ['language_code'] = language_code
        }
...
function api.set_my_name(name, language_code) -- https://core.telegram.org/bots/api#setmyname
  ...
  local success, res = api.request(
      config.endpoint .. api.token .. '/setMyName',
      {
          ['name'] = name,
          ['language_code'] = language_code
      }
...
function api.get_my_name(language_code) -- https://core.telegram.org/bots/api#getmyname
  local success, res = api.request(
      config.endpoint .. api.token .. '/getMyName',
      { ['language_code'] = language_code }
  )
  return success, res
end
...
function api.set_my_description(description, language_code) -- https://core.telegram.org/bots/api#setmydescription
  ...
  local success, res = api.request(
      config.endpoint .. api.token .. '/setMyDescription',
      {
          ['description'] = description,
          ['language_code'] = language_code
      }
...
function api.get_my_description(language_code) -- https://core.telegram.org/bots/api#getmydescription
  local success, res = api.request(
      config.endpoint .. api.token .. '/getMyDescription',
      { ['language_code'] = language_code }
  )
  return success, res
end
...
function api.set_my_short_description(short_description, language_code) -- https://core.telegram.org/bots/api#setmyshortdescription
  ...
  local success, res = api.request(
      config.endpoint .. api.token .. '/setMyShortDescription',
      {
...
function api.get_my_short_description(language_code) -- https://core.telegram.org/bots/api#getmyshortdescription
  local success, res = api.request(
      config.endpoint .. api.token .. '/getMyShortDescription',
      { ['language_code'] = language_code }
  )
  return success, res
end
...
function api.set_chat_menu_button(chat_id, menu_button) -- https://core.telegram.org/bots/api#setchatmenubutton
  ...
  local success, res = api.request(
      config.endpoint .. api.token .. '/setChatMenuButton',
      {
          ['chat_id'] = chat_id,
...
function api.get_chat_menu_button(chat_id) -- https://core.telegram.org/bots/api#getchatmenubutton
  local success, res = api.request(
      config.endpoint .. api.token .. '/getChatMenuButton',
      { ['chat_id'] = chat_id }
  )
  return success, res
end
...
function api.set_my_default_administrator_rights(rights, for_channels) -- https://core.telegram.org/bots/api#setmydefaultadministratorrights
  ...
  local success, res = api.request(
      config.endpoint .. api.token .. '/setMyDefaultAdministratorRights',
      {
          ['rights'] = rights,
...
function api.get_my_default_administrator_rights(for_channels) -- https://core.telegram.org/bots/api#getmydefaultadministratorrights
  local success, res = api.request(
      config.endpoint .. api.token .. '/getMyDefaultAdministratorRights',
      { ['for_channels'] = for_channels }
  )
  return success, res
end
...
function api.delete_messages(chat_id, message_ids) -- https://core.telegram.org/bots/api#deletemessages
    message_ids = type(message_ids) == 'table' and json.encode(message_ids) or message_ids
    local success, res = api.request(
        config.endpoint .. api.token .. '/deleteMessages',
        {
            ['chat_id'] = chat_id,
            ['message_ids'] = message_ids
        }
...
function api.get_custom_emoji_stickers(custom_emoji_ids) -- https://core.telegram.org/bots/api#getcustomemojistickers
    ...
    local success, res = api.request(
        config.endpoint .. api.token .. '/getCustomEmojiStickers',
...
function api.set_sticker_emoji_list(sticker, emoji_list) -- https://core.telegram.org/bots/api#setstickeremojilist
    ...
    local success, res = api.request(
        config.endpoint .. api.token .. '/setStickerEmojiList',
        {
            ['sticker'] = sticker,
...
function api.set_sticker_keywords(sticker, keywords) -- https://core.telegram.org/bots/api#setstickerkeywords
    ...
    local success, res = api.request(
        config.endpoint .. api.token .. '/setStickerKeywords',
        {
            ['sticker'] = sticker,
            ['keywords'] = keywords
        }
...
function api.set_sticker_mask_position(sticker, mask_position) -- https://core.telegram.org/bots/api#setstickermaskposition
    ...
    local success, res = api.request(
        config.endpoint .. api.token .. '/setStickerMaskPosition',
        {
            ['sticker'] = sticker,
...
function api.set_sticker_set_title(name, title) -- https://core.telegram.org/bots/api#setstickersettitle
    ...
    local success, res = api.request(
        config.endpoint .. api.token .. '/setStickerSetTitle',
        {
            ['name'] = name,
            ['title'] = title
        }
...
function api.set_sticker_set_thumbnail(name, user_id, thumbnail) -- https://core.telegram.org/bots/api#setstickersetthumbnail
    local success, res = api.request(
        config.endpoint .. api.token .. '/setStickerSetThumbnail',
        {
            ['name'] = name,
            ['user_id'] = user_id
        },
...
function api.set_custom_emoji_sticker_set_thumbnail(name, custom_emoji_id) -- https://core.telegram.org/bots/api#setcustomemojistickersetthumbnail
    local success, res = api.request(
        config.endpoint .. api.token .. '/setCustomEmojiStickerSetThumbnail',
        {
            ['name'] = name,
...
function api.delete_sticker_set(name) -- https://core.telegram.org/bots/api#deletestickerset
    local success, res = api.request(
        config.endpoint .. api.token .. '/deleteStickerSet',
        { ['name'] = name }
    )
    return success, res
end
...
function api.answer_web_app_query(web_app_query_id, result) -- https://core.telegram.org/bots/api#answerwebappquery
    ...
    local success, res = api.request(
        config.endpoint .. api.token .. '/answerWebAppQuery',
        {
...
function api.create_invoice_link(title, description, payload, provider_token, currency, prices, max_tip_amount, suggested_tip_amounts, provider_data, photo_url, photo_size, photo_width, photo_height, need_name, need_phone_number, need_email, need_shipping_address, send_phone_number_to_provider, send_email_to_provider, is_flexible) -- https://core.telegram.org/bots/api#createinvoicelink
    prices = type(prices) == 'table' and json.encode(prices) or prices
    suggested_tip_amounts = type(suggested_tip_amounts) == 'table' and json.encode(suggested_tip_amounts) or suggested_tip_amounts
    provider_data = type(provider_data) == 'table' and json.encode(provider_data) or provider_data
    local success, res = api.request(
        config.endpoint .. api.token .. '/createInvoiceLink',
        {
            ['title'] = title,
            ['description'] = description,
            ['payload'] = payload,
...
function api.set_passport_data_errors(user_id, errors) -- https://core.telegram.org/bots/api#setpassportdataerrors
  ...
  local success, res = api.request(
      config.endpoint .. api.token .. '/setPassportDataErrors',
      {
          ['user_id'] = user_id,
          ['errors'] = errors
      }
...
function api.chat_permissions(can_send_messages, can_send_audios, can_send_documents, can_send_photos, can_send_videos, can_send_video_notes, can_send_voice_notes, can_send_polls, can_send_other_messages, can_add_web_page_previews, can_change_info, can_invite_users, can_pin_messages, can_manage_topics)
  return {
    ['can_send_messages'] = can_send_messages,
...
function api.chat_administrator_rights(is_anonymous, can_manage_chat, can_delete_messages, can_manage_video_chats, can_restrict_members, can_promote_members, can_change_info, can_invite_users, can_post_messages, can_edit_messages, can_pin_messages, can_post_stories, can_edit_stories, can_delete_stories, can_manage_topics)
  return {
      ['is_anonymous'] = is_anonymous,
      ['can_manage_chat'] = can_manage_chat,
      ['can_delete_messages'] = can_delete_messages,
